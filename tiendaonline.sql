...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 16-04-2023 a las 22:26:16
...
--
ALTER TABLE `pagos`
  ADD CONSTRAINT `pagos_ibfk_1` FOREIGN KEY (`id_producto`) REFERENCES `producto` (`id_producto`);
...
--
ALTER TABLE `producto`
  ADD CONSTRAINT `producto_ibfk_1` FOREIGN KEY (`id_pedido`) REFERENCES `pedidos` (`id_pedido`);
COMMIT;
